...
import {
  ...
  PurchaseSort,
  PurchaseSortItem,
} from '@/hooks/search/purchase/type';
...
export const initPurchaseQuery: RequestPurchaseList &
  PurchaseQueryState = {
  sortType: 'single',
  keyword: '',
  length: LENGTH,
...
type PurchaseQueryStoreType = RequestPurchaseList &
  PurchaseQueryState &
  PurchaseQueryAction;
...
> = (set, get) => ({
  ...
  setQuery: (query: RequestPurchaseList) =>
...
export const usePurchaseQueryStore =
  create<PurchaseQueryStoreType>()(
